...
public class AddReference extends javax.swing.JFrame {
     ...
     */
    public AddReference(Dashboard dash) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 220, 110, 40));
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 220, 110, 40));
    ...
    public void addSpeciality(){
        if(getSelectionType()==1){
             if(!FileService.isRecordExist(FileService.getSpecialityRefferenceFilePath(), referenceField.getText().toLowerCase())){
            FileService.addLine(FileService.getSpecialityRefferenceFilePath(), referenceField.getText());
            ...
            if(!FileService.isRecordExist(FileService.getComplainRefferenceFilePath(), referenceField.getText().toLowerCase())){
             FileService.addLine(FileService.getComplainRefferenceFilePath(), referenceField.getText());
             getDashboard().setTables();
             this.dispose();
            }
            else{
     ...
     public void setSpecialityOption(){
        ...
        setHoverColor(jPanel5,jLabel5);      
         setSelectionType(1);
         refferenceLabel.setText("Enter New Speciality Refference");
    ...
    public void setComplainOption(){
        resetHoverColor(jPanel5,jLabel5);
         ...
         setSelectionType(2);
           refferenceLabel.setText("Enter New Complain Refference");
