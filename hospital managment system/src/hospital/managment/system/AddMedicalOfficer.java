...
import hospital.managment.system.controllers.MedicalOfficerController;
 ...
 * @author sajath
 */
public class AddMedicalOfficer extends javax.swing.JFrame {
    private MedicalOfficer officer;
    private MedicalOfficerController controller;
    ...
    private AddMedicalOfficer() {
    }
    
    public void setController(MedicalOfficerController controller){
    ...
    private void setFileChooser(){
     ...
     public void setEditData(){
          getNameField().setText(getMedicalOfficer().getName());
        getPhoneNumberField().setText(getMedicalOfficer().getphoneNumber());
        getIdCardField().setText(getMedicalOfficer().getIdCardNo());
        getGenderComboBox().setSelectedItem(getMedicalOfficer().getGender());
        getAddressField().setText(getMedicalOfficer().getAddress());
        getMartialStatusComboBox().setSelectedItem(getMedicalOfficer().getMaritalStatus());
        getUserNameField().setText(getMedicalOfficer().getUserName());
        getStaffMailField().setText(getMedicalOfficer().getStrEmailAddress());
        getDobDateChooser().setDate(PipeService.getStringToDateFormat(getMedicalOfficer().getDateOfBirth()));
        getStaffIdField().setText(getMedicalOfficer().getStrStaffId());
        getDateJoinDateChooser().setDate(PipeService.getStringToDateFormat(getMedicalOfficer().getStrDateOfJoining()));
        setAttachment(getMedicalOfficer().getCvFile());
        setPhotoAttachment(getMedicalOfficer().getPhoto());
       ...
       getController().createSpecialityComboBox();
        getspecialityComboBox().setSelectedItem(getMedicalOfficer().getStrSpecialityArea());
    ...
    public MedicalOfficerController getController(){
         return controller;
     }
    ...
    public JComboBox<String> getspecialityComboBox(){
        return this.specialityComboBox;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Medical Officer");
                ...
                .addGroup(receptionPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(receptionPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(receptionPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(specialityComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(31, 31, 31)
                        .addGroup(receptionPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddMedicalOfficer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddMedicalOfficer().setVisible(true);
            }
        });
    }
